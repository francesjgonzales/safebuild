  ...
  return (
    <div>
      ...
      <div className="one-col p-10 m-10 px-40">
        ...
        <p>
          At SafeBuild, we stand at the forefront of the construction industry,
          delivering unparalleled services that epitomize excellence. As a
          distinguished player in the field, we have garnered recognition for
          our unwavering commitment to quality and safety.
        </p>
        <br />
        <p className="header__paragraph">Leading Industry Reputation</p>
        <p>
          SafeBuild proudly holds the esteemed title of a Grade A1 contractor in
          the Contractors Registry System, a testament to our prowess in
          managing and executing construction projects with the highest
          standards. Additionally, we have achieved the distinguished status of
          a Class 1 General Builder under the Licensing of Builders, reinforcing
          our position as a trusted and capable entity in the construction
          domain.
        </p>
        <br />
        ...
        <p>
          ...
          us as leaders in the ever-evolving construction landscape. Choose
          SafeBuild for a construction experience that transcends expectations —
          where safety, quality, and innovation converge to build a better
          tomorrow.
        </p>
      </div>
    </div>
